...
본 장에서는 EKS 환경에서 폐쇄망으로 Kubespray를 이용하여 HyperCloud를 설치하는 방법에 대해서 설명한다.
...
[#EKSBastion]
== EKS 구성 -> 이 부분 주영님 작성 필요(테라폼은 기존 형식 참고용입니다)

본 절에서는 eks를 이용한 클러스터 구성 및 EKS 클러스터를 사용하기 위한 Bastion을  설치하는 방법에 대해서 설명한다.

.eks을 설치하기 위해서는 다음과 같은 사전 준비가 필요하다.
[NOTE]
====
* IAM 계정 발급
*
